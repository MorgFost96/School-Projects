...
class TestAvg:
    def __init__(self):
        ...
        self.test1_entry = Entry(self.test1_frame, \
                                         width=10)
        ...
        self.test2_entry = Entry(self.test2_frame, \
                                         width=10)
        ...
        self.test3_entry = Entry(self.test3_frame, \
                                         width=10)
        ...
        self.avg_label = Label(self.avg_frame, \
        ...
        # Pack the frames.
        self.test1_frame.pack(side='right')
