...
##The average test score is 95.00 and the final grade is Invalid
##>>> 
##Enter the first test score: 80
##Enter the second test score: 85
##Enter the third test score: 90
##The average test score is 85.00 and the final grade is Invalid
##>>> 
##Enter the first test score: 70
##Enter the second test score: 75
##Enter the third test score: 80
##The average test score is 75.00 and the final grade is Invalid
##>>> 
